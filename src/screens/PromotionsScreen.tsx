    ...
    const columns: ColumnProps<PromotionResponse>[] = [
      {
        ...
        <Typography.Title level={4} type='secondary'>N/A</Typography.Title>
      },
      {
        title: 'Name',
        key: 'name',
      ...
      },
      {
        ...
        render: (id: string)=>
          <div>
            <Space>
              <Button className='p-0' type='text' icon={<RiDeleteBin5Fill className="text-danger" size={20} onClick={()=>{
                confirm({
                  title: 'CONFIRM',
              ...
              <Button className='p-0' type='text' icon={<FaEdit className='text-primary' size={20} />}></Button>
            </Space>
          </div>
      }
    ];
